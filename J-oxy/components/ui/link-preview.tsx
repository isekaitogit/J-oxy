...
export const HoverPeek = ({
    ...
    const cardMotionVariants = {
        initial: { opacity: 0, rotateY: -90, transition: { duration: 0.15 } as any },
        animate: { opacity: 1, rotateY: 0, transition: { type: "spring" as const, stiffness: 200, damping: 18 } as any },
        exit: { opacity: 0, rotateY: 90, transition: { duration: 0.15 } as any },
    };

    // Defines how the lens overlay animates.
    const lensMotionVariants = {
        initial: { opacity: 0, scale: 0.7 },
        animate: { opacity: 1, scale: 1, transition: { duration: 0.2, ease: "easeOut" as const } as any },
        exit: { opacity: 0, scale: 0.7, transition: { duration: 0.2, ease: "easeIn" as const } as any },
    };
